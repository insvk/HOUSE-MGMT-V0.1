...
export function App() {
 ...
 ownerId: h.owner_id || prev.ownerId,
 ...
 <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white backdrop-blur-md border-t border-slate-200 flex items-center justify-around py-1.5 px-2 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
 <button
 onClick={() => setActiveTab('dashboard')}
