...
export const GoogleClock: React.FC<GoogleClockProps> = ({ variant ='card', className ='', onPreferenceChange }) => {
 ...
 return (
 <div className={`relative bg-gradient-to-b from-white via-white to-slate-50/80 border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/40 w-full select-none transition-all duration-300 ${className}`}>
 ...
 disabled={isSyncing}
 className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium text-slate-600 hover:text-slate-900 bg-white hover:bg-slate-50 border border-slate-200 rounded-lg shadow-2xs transition-all cursor-pointer active:scale-95 disabled:opacity-50"
 ...
 <div className="my-5 sm:my-7 py-5 sm:py-7 px-4 bg-gradient-to-b from-slate-50/70 to-slate-100/40 rounded-2xl border border-slate-200 shadow-inner">
 ...
 :'text-slate-300 border border-slate-200 bg-white'
 }`}>
 AM
 </span>
 <span className={`px-2 py-0.5 rounded text-[10px] sm:text-xs font-bold tracking-widest font-mono uppercase transition-all ${
 ...
 <span className="px-2 py-1 rounded text-[10px] sm:text-xs font-bold tracking-wider font-mono uppercase bg-slate-200 text-slate-600 border border-slate-300">
 24H
 </span>
 )}
 </div>
 ...
 <div className="w-full max-w-sm sm:max-w-md mx-auto mt-4 sm:mt-5 pt-3 border-t border-slate-200">
