...
User Agent: ${navigator.userAgent}`;
 ...
 className="px-3.5 py-2 rounded-lg bg-white hover:bg-white text-xs font-semibold text-slate-200 flex items-center gap-1.5 transition-colors cursor-pointer"
 >
 {this.state.copied ? (
 <>
