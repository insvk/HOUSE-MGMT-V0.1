          ...
          <div className="max-w-xl w-full bg-[#2a2f34] border border-red-500/30 rounded-xl p-6 shadow-2xl space-y-5">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
              <button
                ...
                className="px-3.5 py-2 rounded-lg bg-white dark:bg-slate-900/10 hover:bg-white dark:bg-slate-900/20 text-xs font-semibold text-slate-200 flex items-center gap-1.5 transition-colors cursor-pointer"
              >
                {this.state.copied ? (
                  <>
