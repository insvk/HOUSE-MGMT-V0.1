...
export const AvatarUploadModal: React.FC<AvatarUploadModalProps> = ({
 ...
 <div className="p-2 rounded-lg bg-white text-white">
 ...
 <button 
 onClick={onClose}
 className="p-1.5 rounded-lg hover:bg-white text-white/80 hover:text-white transition-colors cursor-pointer"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div 
 onClick={() => fileInputRef.current?.click()}
 className="border-2 border-dashed border-slate-300 hover:border-[#405189] bg-slate-50 hover:bg-indigo-50/20 rounded-xl p-8 text-center cursor-pointer transition-all flex flex-col items-center justify-center group"
 >
 ...
 type="button"
 onClick={handleResetToInitials}
 className="px-3 py-2 text-xs font-semibold text-slate-600 hover:text-slate-900 hover:bg-slate-200 rounded-lg transition-colors cursor-pointer"
 >
 Reset to Initials
 </button>
